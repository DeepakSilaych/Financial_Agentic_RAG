...
class StaticStatementSchema(BaseModel):
    ...
    """
    type: Literal["10-K", "10-Q", "Finance", "Legal", "Other"] | str | None = Field(description="The type of the Financial Statement.")
    company_name: str | None = Field(description="The name of the company. If not present, return None.")
    year: str | None = Field(description="The year of the financial statement if present, ex: '2021' in string format. If not present or for any other type of document, return None.")
    quarter: Literal["Q1", "Q2", "Q3"] | str | None = Field(description="The quarter of the report if it is 10-Q financial statement otherwise None.")
            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": DOCUMENT_CONTEXT_PROMPT.format(doc_content=document_first_10_page_text),
                            "cache_control": {"type": "ephemeral"} 
                        },
                        {
                            "type": "text",
                            "text": static_metadata_prompt.format(companies = db.get_companies()),
                        }
                    ]
                }
            ],
