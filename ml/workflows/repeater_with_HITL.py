...
graph.add_conditional_edges(
    ...
    {
        "decompose": nodes.identify_missing_reports.__name__,
...
repeater_with_HITL = graph.compile(
    checkpointer=memory , 
interrupt_before=[nodes.refine_query.__name__,nodes.identify_missing_reports.__name__,nodes.download_missing_reports.__name__]
