...
const EmptyState = () => (
  <div className="h-full flex flex-col items-center justify-center text-center bg-gradient-to-b from-blue-50 to-white">
    <div className="max-w-3xl mx-auto px-6">
      <div className="mb-10">
        ...
        >
          <BotMessageSquareIcon size={60} className="text-blue-600 mx-auto mb-6" />
        </motion.div>
        <h1 className="text-3xl font-bold text-gray-900 mb-3">
          Welcome to FinSight AI
        </h1>
        <p className="text-xl text-gray-700">
          Your intelligent assistant for financial document analysis and insights
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2 mb-12">
        ...
        >
          ...
          <p className="text-gray-600">
            Ask complex questions about your financial documents and receive instant, accurate responses with precise citations
          </p>
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Secure Upload</h3>
          </div>
          <p className="text-gray-600">
            Securely share your financial documents and let our AI analyze them for valuable insights
          </p>
          <ul className="mt-4 text-sm text-gray-500 list-disc list-inside">
      ...
      <div className="text-gray-700 text-lg mb-8">
        Get started by typing a message below or uploading a document
      </div>
...
const ChatContainer = ({ chatId }) => {
    ...
    const setupWebSocket = async () => {
      ...
      try {
        ...
        if (!chatId && pendingMessageRef.current) {
          setLoading(true);
          const newChat = await createChat(pendingMessageRef.current.message);
        ...
        newWs.onmessage = (event) => {
          ...
          if (data.type === 'ping') {
            ...
            setMessages(prev => [...prev, {
              ...
              isUser: false,
              mode: 'chat',
              intermediate_questions: data.intermediate_questions?.map(q => ({
                id: q.id,
                question: q.question,
                answer: q.answer,
                questionType: q.question_type,
  ...
  const handleSendMessage = async (message, mode = 'chat', researchMode = false, selectedFiles = []) => {
    ...
    try {
      ...
      // Reset graph when new message is entered
      resetGraph();
      setShowGraph(true);
  ...
  const handleGraphToggle = (collapsed) => {
    setIsGraphCollapsed(collapsed);
  };
  ...
  return (
    <div ref={containerRef} className="flex h-full h-max-[calc(100vh - 10rem)]">
      <div
        ref={chatContainerRef}
        className="flex-1 flex h-full flex-col overflow-hidden relative"
      ...
      <>
        ...
        <div className='h-screen overflow-y-scroll' style={{ width: `${100 - chatWidth}%` }}>
          <GraphTab 
            ref={graphRef}
            isVisible={showGraph}
